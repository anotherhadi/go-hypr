...
sudo pacman -S hyprland waybar wofi kitty dunst dolphin xdg-desktop-portal-hyprland qt5-wayland qt6-wayland hyprpaper chromium ttf-font-awesome
sudo pacman -S bat bitwarden brave-browser dropbox lazygit less neovim nodejs npm nmap obsidian perl ranger rust go tailscale tmux trash tree ttf-jetbrains-mono-nerd
sudo pacman -S fzf exa tree-sitter starship
